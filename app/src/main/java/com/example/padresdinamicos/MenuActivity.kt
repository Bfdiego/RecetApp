...
class MenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            if (dbAccess.subcategoryDao().obtenerTodasLasSubcategorias().isEmpty()) {
                if (dbAccess.recipeDao().obtenerTodasLasRecetas().isEmpty()) {
                    val recipes = listOf(
                        Recipe(name = "Pasta Carbonara", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("Italia", "Pasta", "Carbonara"), ingredients = listOf("Spaguetti", "Tocino", "Parmesano", "Huevo")),
                        Recipe(name = "Pizza Margarita", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("Italia", "Pizza", "Margarita"), ingredients = listOf("Masa", "Tomate", "Mozzarella", "Albahaca")),
                        Recipe(name = "Lasagna", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("Italia", "Lasagna"), ingredients = listOf("Pasta", "Carne", "Queso", "Tomate")),
                        Recipe(name = "Risotto al pesto", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("Italia", "Risotto", "Pesto"), ingredients = listOf("Arroz", "Pescado", "Pesto", "Ajo")),
                        Recipe(name = "Tiramisu", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("Italia", "Tiramisu"), ingredients = listOf("Masa", "Chocolate", "Leche", "Canela")),
                        Recipe(name = "Tacos al Pastor", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("México", "Tacos", "Pastor"), ingredients = listOf("Tortilla", "Carne al Pastor", "Cilantro", "Cebolla", "Piña")),
                        Recipe(name = "Enchiladas Verdes", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("México", "Enchiladas", "Verdes"), ingredients = listOf("Tortillas", "Salsa verde", "Pollo", "Cebolla","Crema")),
                        Recipe(name = "Guacamole", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("México", "Guacamole"), ingredients = listOf("Aguacate", "Tomate", "Cebolla", "Cilantro", "Lima")),
                        Recipe(name = "Chiles Rellenos", image = R.drawable.recetapplogo, category =  "Paises", subcategories = listOf("México", "Chiles", "Rellenos"), ingredients = listOf("Chile poblano", "Carne molida", "Queso", "Salsa")),
                        Recipe(name = "Pozole", image = R.drawable.recetapplogo, category = "Paises", subcategories = listOf("México", "Pozole"), ingredients = listOf("Maíz hominy", "Carne de cerdo o pollo", "Ajo", "Cebolla", "Orégano", "Chile en polvo", "Limón", "Rábanos", "Lechuga")),
                        Recipe(name = "Sushi (Maki Rolls)", image = R.drawable.recetapplogo, category = "Japón", subcategories = listOf("Japón", "Sushi", "Maki Rolls"), ingredients = listOf("Arroz para sushi", "Alga nori", "Pescado crudo (salmón o atún)", "Pepino", "Aguacate", "Vinagre de arroz", "Azúcar", "Sal")),
                        Recipe(name = "Ramen", image = R.drawable.recetapplogo, category = "Japón", subcategories = listOf("Japón", "Ramen"), ingredients = listOf("Fideos de ramen", "Caldo de pollo o cerdo", "Salsa de soja", "Huevo cocido", "Cebollines", "Alga nori", "Chashu (carne de cerdo)")),
                        Recipe(name = "Tempura", image = R.drawable.recetapplogo, category = "Japón", subcategories = listOf("Japón", "Tempura"), ingredients = listOf("Mariscos (camarones, calamares)", "Verduras (zanahoria, calabacín, berenjena)", "Harina de trigo", "Huevo", "Agua fría", "Aceite para freír")),
                        Recipe(name = "Okonomiyaki", image = R.drawable.recetapplogo, category = "Japón", subcategories = listOf("Japón", "Okonomiyaki"), ingredients = listOf("Harina de trigo", "Huevo", "Col rallada", "Cebollín", "Tocino o cerdo", "Salsa okonomiyaki", "Mayonesa japonesa", "Katsuobushi (copos de bonito seco)")),
                        Recipe(name = "Dorayaki", image = R.drawable.recetapplogo, category = "Japón", subcategories = listOf("Japón", "Dorayaki"), ingredients = listOf("Harina de trigo", "Huevo", "Azúcar", "Miel", "Pasta de frijol rojo (anko)", "Bicarbonato de sodio")),
                        Recipe(name = "Silpancho", image = R.drawable.recetapplogo, category = "Bolivia", subcategories = listOf("Bolivia", "Silpancho"), ingredients = listOf("Carne de res", "Arroz", "Papa", "Huevo", "Cebolla", "Tomate")),
                        Recipe(name = "Plato Paceño", image = R.drawable.recetapplogo, category = "Bolivia", subcategories = listOf("Bolivia", "Plato Paceño"), ingredients = listOf("Arroz", "Papa", "Carne de res", "Chicharrón", "Salsa de maní")),
                        Recipe(name = "Majadito", image = R.drawable.recetapplogo, category = "Bolivia", subcategories = listOf("Bolivia", "Majadito"), ingredients = listOf("Arroz", "Carne de res", "Plátano", "Huevo", "Verduras")),
                        Recipe(name = "Sopa de Maní", image = R.drawable.recetapplogo, category = "Bolivia", subcategories = listOf("Bolivia", "Sopa de Maní"), ingredients = listOf("Maní", "Carne de res", "Papa", "Fideos", "Verduras")),
                        Recipe(name = "Pique a lo Macho", image = R.drawable.recetapplogo, category = "Bolivia", subcategories = listOf("Bolivia", "Pique a lo Macho"), ingredients = listOf("Carne de res", "Papa", "Cebolla", "Tomate", "Ají rojo")),
                        Recipe(name = "Quiche Lorraine", image = R.drawable.recetapplogo, category = "Francia", subcategories = listOf("Francia", "Quiche Lorraine"), ingredients = listOf("Masa quebrada", "Huevo", "Crema de leche", "Bacon", "Queso Gruyère", "Cebolla", "Pimienta")),
                        Recipe(name = "Ratatouille", image = R.drawable.recetapplogo, category = "Francia", subcategories = listOf("Francia", "Ratatouille"), ingredients = listOf("Berenjena", "Calabacín", "Pimiento rojo", "Tomate", "Cebolla", "Ajo", "Aceite de oliva", "Hierbas provenzales")),
                        Recipe(name = "Soupe à l'Oignon", image = R.drawable.recetapplogo, category = "Francia", subcategories = listOf("Francia", "Soupe à l'Oignon"), ingredients = listOf("Cebolla", "Caldo de carne", "Vino blanco", "Pan", "Queso Gruyère", "Mantequilla", "Harina")),
                        Recipe(name = "Croissant", image = R.drawable.recetapplogo, category = "Francia", subcategories = listOf("Francia", "Croissant"), ingredients = listOf("Harina", "Mantequilla", "Levadura", "Leche", "Azúcar", "Sal", "Huevos")),
                        Recipe(name = "Crème Brûlée", image = R.drawable.recetapplogo, category = "Francia", subcategories = listOf("Francia", "Crème Brûlée"), ingredients = listOf("Yemas de huevo", "Crema de leche", "Azúcar", "Vainilla", "Azúcar moreno (para caramelizar)")),
                        Recipe(name = "Pancakes", image = R.drawable.recetapplogo, category = "Desayuno", subcategories = listOf("Desayuno", "Pancakes"), ingredients = listOf("Harina", "Leche", "Huevo", "Azúcar", "Mantequilla", "Polvo de hornear", "Miel", "Frutas (opcional)")),
                        Recipe(name = "Smoothie Bowl", image = R.drawable.recetapplogo, category = "Desayuno", subcategories = listOf("Desayuno", "Smoothie Bowl"), ingredients = listOf("Frutas congeladas", "Leche o yogur", "Granola", "Semillas", "Frutas frescas", "Miel")),
                        Recipe(name = "Huevos Benedictinos", image = R.drawable.recetapplogo, category = "Desayuno", subcategories = listOf("Desayuno", "Huevos Benedictinos"), ingredients = listOf("Huevos", "Pan tostado", "Jamón", "Salsa holandesa", "Vinagre", "Sal", "Pimienta")),
                        Recipe(name = "Avena con Frutas", image = R.drawable.recetapplogo, category = "Desayuno", subcategories = listOf("Desayuno", "Avena con Frutas"), ingredients = listOf("Avena", "Leche", "Miel", "Frutas (plátano, fresas, arándanos)", "Frutos secos")),
                        Recipe(name = "Tostadas de Aguacate", image = R.drawable.recetapplogo, category = "Desayuno", subcategories = listOf("Desayuno", "Tostadas de Aguacate"), ingredients = listOf("Pan integral", "Aguacate", "Huevo", "Sal", "Pimienta", "Aceite de oliva")),
                        Recipe(name = "Bruschettas", image = R.drawable.recetapplogo, category = "Aperitivos", subcategories = listOf("Aperitivos", "Bruschettas"), ingredients = listOf("Pan baguette", "Tomate", "Albahaca", "Ajo", "Aceite de oliva", "Vinagre balsámico")),
                        Recipe(name = "Hummus con Pita", image = R.drawable.recetapplogo, category = "Aperitivos", subcategories = listOf("Aperitivos", "Hummus con Pita"), ingredients = listOf("Garbanzos", "Tahini", "Ajo", "Limón", "Aceite de oliva", "Pita")),
                        Recipe(name = "Sopa de Tomate", image = R.drawable.recetapplogo, category = "Aperitivos", subcategories = listOf("Aperitivos", "Sopa de Tomate"), ingredients = listOf("Tomates", "Cebolla", "Ajo", "Caldo de pollo", "Aceite de oliva", "Sal", "Pimienta")),
                        Recipe(name = "Calamares Fritos", image = R.drawable.recetapplogo, category = "Aperitivos", subcategories = listOf("Aperitivos", "Calamares Fritos"), ingredients = listOf("Calamares", "Harina", "Sal", "Pimienta", "Aceite para freír", "Limón")),
                        Recipe(name = "Tabule", image = R.drawable.recetapplogo, category = "Aperitivos", subcategories = listOf("Aperitivos", "Tabule"), ingredients = listOf("Trigo bulgur", "Perejil", "Tomate", "Pepino", "Cebolla", "Menta", "Jugo de limón", "Aceite de oliva")),
                        Recipe(name = "Pollo al Curry", image = R.drawable.recetapplogo, category = "Plato Principal", subcategories = listOf("Plato Principal", "Pollo al Curry"), ingredients = listOf("Pollo", "Curry en polvo", "Cebolla", "Ajo", "Leche de coco", "Tomate", "Aceite de oliva", "Arroz")),
                        Recipe(name = "Espagueti Boloñesa", image = R.drawable.recetapplogo, category = "Plato Principal", subcategories = listOf("Plato Principal", "Espagueti Boloñesa"), ingredients = listOf("Espagueti", "Carne molida de res", "Tomate", "Cebolla", "Ajo", "Aceite de oliva", "Pasta de tomate", "Vino tinto")),
                        Recipe(name = "Estofado de Res", image = R.drawable.recetapplogo, category = "Plato Principal", subcategories = listOf("Plato Principal", "Estofado de Res"), ingredients = listOf("Carne de res", "Zanahoria", "Papa", "Cebolla", "Ajo", "Caldo de res", "Pimiento", "Laurel", "Aceite de oliva")),
                        Recipe(name = "Paella", image = R.drawable.recetapplogo, category = "Plato Principal", subcategories = listOf("Plato Principal", "Paella"), ingredients = listOf("Arroz", "Mariscos", "Pollo", "Pimiento", "Guisante", "Tomate", "Caldo de pollo", "Azafrán", "Aceite de oliva")),
                        Recipe(name = "Salmón a la Plancha", image = R.drawable.recetapplogo, category = "Plato Principal", subcategories = listOf("Plato Principal", "Salmón a la Plancha"), ingredients = listOf("Salmón", "Aceite de oliva", "Limón", "Ajo", "Pimienta", "Sal", "Perejil")),
                        Recipe(name = "Cheesecake", image = R.drawable.recetapplogo, category = "Postres", subcategories = listOf("Postres", "Cheesecake"), ingredients = listOf("Galletas Digestive", "Queso crema", "Azúcar", "Huevos", "Crema de leche", "Esencia de vainilla", "Mantequilla")),
                        Recipe(name = "Brownies", image = R.drawable.recetapplogo, category = "Postres", subcategories = listOf("Postres", "Brownies"), ingredients = listOf("Harina", "Chocolate", "Azúcar", "Mantequilla", "Huevos", "Nueces", "Esencia de vainilla")),
                        Recipe(name = "Arroz con Leche", image = R.drawable.recetapplogo, category = "Postres", subcategories = listOf("Postres", "Arroz con Leche"), ingredients = listOf("Arroz", "Leche", "Azúcar", "Canela", "Cáscara de limón", "Esencia de vainilla")),
                        Recipe(name = "Flan", image = R.drawable.recetapplogo, category = "Postres", subcategories = listOf("Postres", "Flan"), ingredients = listOf("Leche", "Azúcar", "Huevos", "Esencia de vainilla", "Caramelo")),
                        Recipe(name = "Churros", image = R.drawable.recetapplogo, category = "Postres", subcategories = listOf("Postres", "Churros"), ingredients = listOf("Harina", "Agua", "Azúcar", "Sal", "Aceite", "Canela", "Chocolate para mojar")),
                        Recipe(name = "Mojito", image = R.drawable.recetapplogo, category = "Bebidas", subcategories = listOf("Bebidas", "Mojito"), ingredients = listOf("Ron blanco", "Menta", "Azúcar", "Limón", "Agua con gas", "Hielo")),
                        Recipe(name = "Margarita", image = R.drawable.recetapplogo, category = "Bebidas", subcategories = listOf("Bebidas", "Margarita"), ingredients = listOf("Tequila", "Triple sec", "Jugo de lima", "Sal", "Hielo")),
                        Recipe(name = "Té Matcha", image = R.drawable.recetapplogo, category = "Bebidas", subcategories = listOf("Bebidas", "Té Matcha"), ingredients = listOf("Té matcha", "Leche", "Azúcar", "Hielo")),
                        Recipe(name = "Batido de Fresa", image = R.drawable.recetapplogo, category = "Bebidas", subcategories = listOf("Bebidas", "Batido de Fresa"), ingredients = listOf("Fresas", "Leche", "Yogur", "Miel", "Hielo")),
                        Recipe( name = "Horchata", image = R.drawable.recetapplogo, category = "Bebidas", subcategories = listOf("Bebidas", "Horchata"), ingredients = listOf("Arroz", "Canela", "Azúcar", "Leche", "Vainilla", "Hielo"))
                    )
                ...
                recyclerSubcategoryAdapter.addDataToList(dbAccess.subcategoryDao().obtenerTodasLasSubcategorias())
