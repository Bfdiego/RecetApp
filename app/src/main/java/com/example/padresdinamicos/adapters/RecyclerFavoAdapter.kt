...
import com.example.padresdinamicos.databinding.ItemRecipeFavBinding
import com.example.padresdinamicos.dataclasses.Recipe

class RecyclerFavoAdapter: RecyclerView.Adapter<RecyclerFavoAdapter.EjemploViewHolder>() {
    ...
    inner class EjemploViewHolder(private val binding: ItemRecipeFavBinding) :
